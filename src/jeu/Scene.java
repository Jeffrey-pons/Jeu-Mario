...
public class Scene extends JPanel {
	...
	public Scene(){
		...
		this.addKeyListener(new jeu.Clavier()); // Ecouteur Clavier
		...
		Thread chronoEcran = new Thread(new jeu.Chrono()); // Ajout d'un chronom�tre � PanJeu
	...
	public void paintComponent(Graphics g) {
		...
		// Image de mario
		if(jeu.Main.scene.mario.isVivant() == true){
